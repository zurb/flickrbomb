(function ($) {
  var localStorage = (supports_local_storage()) ? new Store("flickrBombImages") : null,
      ...
      ImageView = Backbone.View.extend({
        ...
        template: _.template('<div class="flickrbombWrapper"><img class="flickrbomb" src="" /><a href="#" class="setupIcon"></a></div><div class="flickrbombFlyout"><a href="#" class="next">reload</a></div>'),
